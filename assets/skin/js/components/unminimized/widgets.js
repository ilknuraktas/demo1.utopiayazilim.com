(function ($) {
  ...
  Utopia.behaviors.widgets_carousel_init = {
    attach: function (context, settings) {
      ...
      if ($('.brs-carousel').length) {
        ...
        if (typeof $.fn.slick === 'undefined') {
          ...
          setTimeout(Utopia.behaviors.widgets_carousel_init.attach, settings.timeout_delay, context, settings);
          return;
        }
  ...
  Utopia.behaviors.widgets_slider_cube_init = {
    attach: function (context, settings) {
      ...
      if (sliderCube.length) {
        ...
        if (typeof Swiper === 'undefined') {
          ...
          setTimeout(Utopia.behaviors.widgets_slider_cube_init.attach, settings.timeout_delay, context, settings);
          return;
        }
  ...
  Utopia.behaviors.widgets_price_slider_init = {
    attach: function (context, settings) {
      // Filter slider 
      ...
      if (sliderContainers.length) {
        ...
        if (typeof $.fn.slider !== 'function') {
          ...
          setTimeout(Utopia.behaviors.widgets_price_slider_init.attach, settings.timeout_delay, context, settings);
          return;
        }
