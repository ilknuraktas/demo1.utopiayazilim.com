(function ($) {
  ...
  Utopia.behaviors.tables_hv_init = {
  ...
  Utopia.behaviors.data_tables_init = {
    attach: function (context, settings) {
      ...
      if(typeof brk === 'undefined') {
        ...
        if (strictTables.length) {
          ...
          if (typeof $.fn.DataTable === 'undefined') {
            ...
            setTimeout(Utopia.behaviors.data_tables_init.attach, settings.timeout_delay, context, settings);
            return;
          }
