if (window.location.origin == 'http://html.Utopia.nikadevs.com' || window.location.origin == 'https://html.Utopia.nikadevs.com') {
...
var Utopia = Utopia || {'settings': {timeout_delay: 200}, 'behaviors': {}};

var brk_xmode = false;
// Put your google maps api key here
Utopia.settings.gmap_api_key = typeof brk !== 'undefined' && typeof brk.gmap_api_key !== 'undefined' ? brk.gmap_api_key : "";
// Put your Re-Captcha key here
Utopia.settings.recaptcha_api_key = typeof brk !== 'undefined' && typeof brk.recaptcha_api_key !== 'undefined' ? brk.recaptcha_api_key : "6Lfsu3QUAAAAAO6j2iAsncliNSQqISfipl0DjPAp";
// Advanced: If your real project path is different then in the URL
Utopia.settings.project_prefix = typeof brk !== 'undefined' && typeof brk.shorcodesurl !== 'undefined' ? brk.shorcodesurl : '';
...
(function ($) {
  ...
  * Behaviors engine
  */
  Utopia.attachBehaviors = function (context, settings) {
    context = context || document;
    settings = settings || Utopia.settings;
    // Execute all of them.
    $.each(Utopia.behaviors, function () {
  ...
  */
  ...
  // Scroll to top
  Utopia.behaviors.smooth_scroll_top = {
  ...
  // Bordered theme
  Utopia.behaviors.border_theme_init = {
    attach: function (context, settings) {
  ...
  // Jquery Counter
  Utopia.behaviors.counter_lib_init = {
    attach: function (context, settings) {
      (function (b) {
  ...
  Utopia.behaviors.fancybox_init = {
    attach: function (context, settings) {
      ...
      if (typeof $.fn.fancybox === 'undefined') {
        ...
        setTimeout(Utopia.behaviors.fancybox_init.attach, 200, context, settings);
        return;
      }
  ...
  // scrollbar-inner
  Utopia.behaviors.scrollbar_init = {
    attach: function (context, settings) {
      ...
      $(context).parent().find('.scrollbar-inner:not(.rendered)').addClass('rendered').each(function () {
        if ($(this).length) {
          ...
          if (typeof $.fn.scrollbar === 'undefined') {
            ...
            setTimeout(Utopia.behaviors.scrollbar_init.attach, 200, context, settings);
            return;
          }
  ...
  var adds = {
    ...
    lazyUrls = {
      "component__map": {
        "js": [
          "https://maps.googleapis.com/maps/api/js?key=" + Utopia.settings.gmap_api_key,
      ...
      "recaptcha": {
        "js": [
          "https://www.google.com/recaptcha/api.js?render=" + Utopia.settings.recaptcha_api_key,
        ...
        if (typeof lazyUrls[required_libs[j]].js !== 'undefined') {
          ...
          for (var i in lazyUrls[required_libs[j]].js) {
            if (!uniqueLazyUrls[lazyUrls[required_libs[j]].js[i]]) {
              ...
              prefix = Utopia.settings.project_prefix && lazyUrls[required_libs[j]].js[i].indexOf('//') === -1 ? Utopia.settings.project_prefix : '';
        ...
        if (typeof lazyUrls[required_libs[j]].css !== 'undefined') {
          for (i in lazyUrls[required_libs[j]].css) {
            if (!uniqueLazyUrls[lazyUrls[required_libs[j]].css[i]]) {
              ...
              prefix = Utopia.settings.project_prefix && lazyUrls[required_libs[j]].css[i].indexOf('//') === -1 ? Utopia.settings.project_prefix : '';
  ...
  */
  ...
  function brs_add_libraries() {
    ...
    if (Object.keys(adds.css).length) {
      ...
      for (i in adds.css) {
        prefix = Utopia.settings.project_prefix && adds.css[i].indexOf('//') === -1 ? Utopia.settings.project_prefix : '';
    ...
    if (Object.keys(adds.js).length) {
      var loaded_js = 0;
      for (i in adds.js) {
        prefix = Utopia.settings.project_prefix && adds.js[i].indexOf('//') === -1 ? Utopia.settings.project_prefix : '';
...
(function($){
  ...
  /* End Load bg */
    ...
    if(dataHtmlSkin.indexOf(themeOptionsColorData + '.css') + 1) {
      ...
      brkSkinColor.attr('href', Utopia.settings.project_prefix + 'css/skins/' + themeOptionsColorData + '.css'); // WordPress
	...
	$optBorder.each(function () {
		...
		$this.on('click', function (e) {
			...
			if($dataBorder !== 0) {
				...
				Utopia.behaviors.border_theme_init.attach($(document));
			} else {
...
(function ($) {
    ...
    attach: function (context, settings) {
      ...
      $(context).parent().find('.brk-header:not(.rendered)').addClass('rendered').each(function () {
        ...
        function headerMobile(widthDoc) {
          ...
          if (wrapMobileClass.length) {
            brkHeaderMobileClose.on('click', function () {
              $('body').removeClass('brk-modal2-open');
        ...
        infoMenuOpen.on('click', function () {
          ...
          if (windowWidth >= widthDoc) {
            imBody.toggleClass('brk-modal2-open');
            if(imBody.hasClass('brk-modal2-open')) {
        ...
        infoMenuClose.on('click', function () {
          ...
          if (windowWidth >= widthDoc) {
            if (imBody.hasClass('brk-modal2-open')) {
              imBody.removeClass('brk-modal2-open');
            }
            if(imBody.hasClass('brk-modal2-open')) {
              imBody.attr('style', '--mr:' + mr + 'px');
            } else {
  ...
  Utopia.behaviors.header_init_menu_flex = {
    attach: function (context, settings) {
      ...
      if (typeof $.fn.flexMenu !== 'function') {
        ...
        setTimeout(Utopia.behaviors.header_init_menu_flex.attach, settings.timeout_delay, context, settings);
        return;
      }
...
(function ($) {
  ...
  Utopia.behaviors.accordions_init = {
    attach: function (context, settings) {
...
(function ($) {
  ...
  Utopia.behaviors.tabs_slider_init = {
    attach: function (context, settings) {
      ...
      if ($('.brk-slider').length) {
        ...
        if (typeof $.fn.slick === 'undefined') {
          ...
          setTimeout(Utopia.behaviors.tabs_slider_init.attach, settings.timeout_delay, context, settings);
          return;
        }
...
(function ($) {
  ...
  $.fn.Utopiaforms = function (params) {
    var defaults = {
...
(function ($) {
  Utopia.behaviors.form_controls = {
    attach: function (context, settings) {
      ...
      $(brkForms).Utopiaforms();

      if (typeof $.fn.styler === 'undefined') {
        console.log('Waiting for the styler library');
        setTimeout(Utopia.behaviors.form_controls.attach, settings.timeout_delay, context, settings);
        return;
      }
...
(function ($) {
  ...
  Utopia.behaviors.media_embeds_init = {
    attach: function (context, settings) {
...
(function ($) {
  ...
  Utopia.behaviors.image_map_init = {
    attach: function (context, settings) {      
      ...
      if (typeof $.fn.imageMapPro !== 'function') {
        ...
        setTimeout(Utopia.behaviors.image_map_init.attach, settings.timeout_delay, context, settings);
        return;
      }
...
(function ($) {
  ...
  Utopia.behaviors.footer_init = {
    attach: function (context, settings) {
      ...
      if ($('.brk-slider_shop-footer:not(.rendered)').length) {
        if (typeof $.fn.slick === 'undefined') {
          console.log('Waiting for the slick library');
          setTimeout(Utopia.behaviors.footer_init.attach, settings.timeout_delay, context, settings);
          return;
        }
  ...
  Utopia.behaviors.footer_scrollr_init = {
    attach: function (context, settings) {
      if($('[data-skrollr]:not(.skrollr-rendered)').length){
        if (typeof skrollr === 'undefined') {
          console.log('Waiting for the skrollr library');
          setTimeout(Utopia.behaviors.footer_scrollr_init.attach, settings.timeout_delay, context, settings);
          return;
        }
...
(function ($) {
  ...
  Utopia.behaviors.portfolio_masonry_init = {
    attach: function (context, settings) {
      ...
      if (typeof Isotope !== 'function') {
        ...
        setTimeout(Utopia.behaviors.portfolio_masonry_init.attach, settings.timeout_delay, context, settings);
        return;
      }
...
(function ($) {
  ...
  Utopia.behaviors.progressbar_init = {
    attach: function (context, settings) {
...
(function ($) {
  ...
  Utopia.behaviors.portfolio_rows_init = {
    attach: function (context, settings) {
      ...
      if (typeof Isotope !== 'function' && typeof $.fn.brk_hover3d !== 'function' || typeof anime !== 'function') {
        ...
        setTimeout(Utopia.behaviors.portfolio_rows_init.attach, settings.timeout_delay, context, settings);
        return;
      }
...
(function ($) {
  ...
  Utopia.behaviors.parallax_video_init = {
    attach: function (context, settings) {
      ...
      if (typeof jQuery.mbYTPlayer === 'undefined' || typeof jQuery.vimeo_player === 'undefined') {
        ...
        setTimeout(Utopia.behaviors.parallax_video_init.attach, settings.timeout_delay, context, settings);
        return;
      }
...
(function ($) {
  ...
  Utopia.behaviors.sliders_page_init = {
    attach: function (context, settings) {
      ...
      if (typeof  $.fn.slick === 'undefined') {
        console.log('Waiting for the slick library');
        setTimeout(Utopia.behaviors.sliders_page_init.attach, settings.timeout_delay, context, settings);
        return;
      }
...
(function ($) {
  ...
  Utopia.behaviors.ranged_slider_init = {
    attach: function (context, settings) {
      ...
      if (typeof $.fn.slider === 'undefined') {
        ...
        setTimeout(Utopia.behaviors.ranged_slider_init.attach, settings.timeout_delay, context, settings);
        return;
      }
...
(function ($) {
  ...
  Utopia.behaviors.info_box_init = {
    attach: function (context, settings) {
...
(function ($) {
  ...
  Utopia.behaviors.tiles_angle_init = {
    attach: function (context, settings) {
...
(function ($) {
  ...
  Utopia.behaviors.blog__page_init = {
    attach: function (context, settings) {
