...
function remove_from_featured(val) {
    ...
    $.ajax({
        type: "POST",
        url: base_url + "product_admin_controller/add_remove_featured_products",
        data: data,
        success: function (response) {
            location.reload();
        }
...
function bayi_users(id) {
    ...
    $.ajax({
        type: "POST",
        url: base_url + "admin_controller/bayi_users",
        data: data,
        success: function (response) {
            location.reload();
        }
...
function approve_selected_comments() {
    ...
    $.ajax({
        type: "POST",
        url: base_url + "product_admin_controller/approve_selected_comments",
        data: data,
        success: function (response) {
            location.reload();
        }
