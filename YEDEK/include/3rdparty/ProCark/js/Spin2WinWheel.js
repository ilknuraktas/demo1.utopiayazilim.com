function Spin2WinWheel() {
  ...
  var xmlns = "http://www.w3.org/2000/svg",
    ...
    spinVelocityTracker,
    gameResultsArray = [],
    pegSnd = new Audio('include/3rdparty/ProCark/media/wheel_tick.mp3'),
    ...
    $('.spinBtn').remove();
   // window.open('./include/mod_page_myprocark.php?act=win&ID=' + segmentValuesArray[e].userData['ID'] + '&check=' + segmentValuesArray[e].userData['check']);
		$.get('./include/mod_page_myprocark.php?act=win&ID=' + segmentValuesArray[e].userData['ID'] + '&check=' + segmentValuesArray[e].userData['check'], function(data) {
			showToast(data);
		});
		
		resultStr2 = 'Promosyon Kodu :<br /><input type="text" class="pro-code" value="ASDASDVSD">';
		...
		//alert(segmentValuesArray[e].userData['ID']);
    ...
    showIntroText = function(str) {
	  $('#procark').height($('.wheelSVG').outerHeight() + $('.spinBtn').outerHeight() + 10);
      showToast(introText);
    },
