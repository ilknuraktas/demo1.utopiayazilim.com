...
class VposThreeDIntegration extends BaseClass
{
    ...
    function doSale($Amount, $CurrencyCode, $OrderId, $merchantMessageData , ThreeDSecureData $ThreeDSecureData)
    {
    ...
    function doSaleWithPoint($Amount, $CurrencyCode, $OrderId, $Point, $merchantMessageData, ThreeDSecure $ThreeDSecureData)
    {
    ...
    function doSaleWithInstallment($Amount, $CurrencyCode, $OrderId, $InstallmentCount, $merchantMessageData ,ThreeDSecure $ThreeDSecureData)
    {
		if($merchantMessageData != "")
		{
			$this->requestData['merchantMessageData'] = $merchantMessageData;
    ...
    function doSaleWithPointAndInstalment($Amount, $CurrencyCode, $OrderId, $Point, $InstallmentCount, $merchantMessageData ,ThreeDSecure $ThreeDSecureData)
    {
    ...
    // Auth
    function doAuth($Amount, $CurrencyCode, $OrderId, $merchantMessageData , ThreeDSecure $ThreeDSecureData)
    {
    ...
    function doAuthWithInstallment($Amount, $CurrencyCode, $OrderId, $InstallmentCount, $merchantMessageData , ThreeDSecure $ThreeDSecureData)
    {
		if($merchantMessageData != "")
		{
			$this->requestData['merchantMessageData'] = $merchantMessageData;
    ...
    // Vft
    function doVft($Amount, $CurrencyCode, $OrderID, $InstallmentCount, $VftCode, $merchantMessageData , ThreeDSecure $ThreeDSecureData)
    {
    ...
    // DoPointUsage
    function doPointUsage($Amount, $CurrencyCode, $OrderId, ThreeDSecure $ThreeDSecureData)
    {
        $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
        $this->requestData['MAC'] = $this->getMac3D($ThreeDSecureData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    ...
    // Turkcell
    function doTurkcellSale($OrderId, $packetCode, $gsmNo, ThreeDSecure $ThreeDSecureData)
    {
        $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
        $this->requestData['MAC'] = $this->getMac3D($ThreeDSecureData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    ...
    // function doTrioSingleWithTerminalDayCount($Amount, $CurrencyCode,$OrderId ,$firmTerminalId, $extraRefNo, $terminalDayCount,ThreeDSecure $ThreeDSecureData){
    // $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
    // $this->requestData['MAC']= $this->getMac3D($ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    // $this->requestData['Amount']=$Amount;
    ...
    // }
    // function doTrioSingleWithDueDate($Amount, $CurrencyCode, $OrderId, $firmTerminalId, $extraRefNo, $dueDate,ThreeDSecure $ThreeDSecureData){
    // $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
    // $this->requestData['MAC']= $this->getMac3D($ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    // $this->requestData['Amount']=$Amount;
    ...
    // function doTrioMultipleWithTerminalDayCount ($Amount, $CurrencyCode,$OrderId , $InstallmentCount, $firmTerminalId, $extraRefNo, $terminalDayCount,ThreeDSecure $ThreeDSecureData){
    // $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
    // $this->requestData['MAC']= $this->getMac3D($ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    // $this->requestData['Amount']=$Amount;
    ...
    // function doTrioMultipleWithDueDate ($Amount, $CurrencyCode,$OrderId , $InstallmentCount, $firmTerminalId, $extraRefNo, $dueDate,ThreeDSecure $ThreeDSecureData){
    // $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
    // $this->requestData['MAC']= $this->getMac3D($ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    // $this->requestData['Amount']=$Amount;
    ...
    // //TODO: response
    // function doTrioFlexibleWithTerminalDayCount ($CurrencyCode, $OrderId, $InstallmentCount, $firmTerminalId, $extraRefNo, $terminalDayCount,$dueInfoList,ThreeDSecure $ThreeDSecureData){
    // $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
    // $this->requestData['MAC']= $this->getMac3D($ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    // $this->requestData['CurrencyCode']=$CurrencyCode;
    ...
    // function doTrioFixed($noWarranty, $amount, $currencyCode,$OrderId, $firmTerminalId, $extraRefNo,ThreeDSecure $ThreeDSecureData){
    // $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
    // $this->requestData['MAC']= $this->getMac3D($ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
