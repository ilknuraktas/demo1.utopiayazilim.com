...
class VposDealerTDIntegration extends BaseClass
{
    ...
    // Sale
    function doSale($Amount, $CurrencyCode, $OrderId, $merchantMessageData, ThreeDSecure $ThreeDSecureData, DealerData $dealerData)
    {
    ...
    function doSaleWithPoint($Amount, $CurrencyCode, $OrderId, $Point,$merchantMessageData, ThreeDSecure $ThreeDSecureData, DealerData $dealerData)
    {
    ...
    function doSaleWithInstallment($Amount, $CurrencyCode, $OrderId, $InstallmentCount, $merchantMessageData,ThreeDSecure $ThreeDSecureData, DealerData $dealerData)
    {
    ...
    function doSaleWithPointAndInstalment($Amount, $CurrencyCode, $OrderId, $Point, $InstallmentCount, $merchantMessageData , ThreeDSecure $ThreeDSecureData, DealerData $dealerData)
    {
		if($merchantMessageData != "")
		{
			$this->requestData['merchantMessageData'] = $merchantMessageData;
    ...
    {
        $this->requestData['MAC'] = $this->getMac3D($saleRequestData->ThreeDSecureData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    ...
    // Auth
    function doAuth($Amount, $CurrencyCode, $OrderId, $merchantMessageData , ThreeDSecure $ThreeDSecureData, DealerData $dealerData)
    {
    ...
    function doAuthWithInstallment($Amount, $CurrencyCode, $OrderId, $InstallmentCount, $merchantMessageData , ThreeDSecure $ThreeDSecureData, DealerData $dealerData)
    {
    ...
    // Vft
    function doVft($Amount, $CurrencyCode, $OrderID, $InstallmentCount, $VftCode, $merchantMessageData ,ThreeDSecure $ThreeDSecureData, DealerData $dealerData)
    {
		if($merchantMessageData != "")
		{
			$this->requestData['merchantMessageData'] = $merchantMessageData;
    ...
    // DoPointUsage
    function doPointUsage($Amount, $CurrencyCode, $OrderId, ThreeDSecure $ThreeDSecureData, DealerData $dealerData)
    {
        $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMac3D($ThreeDSecureData);
    ...
    // Turkcell
    function doTurkcellSale($OrderId, $packetCode, $gsmNo, ThreeDSecure $ThreeDSecureData, DealerData $dealerData)
    {
        $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMac3D($ThreeDSecureData);
    ...
    // function doTrioSingleWithTerminalDayCount($Amount, $CurrencyCode,$OrderId ,$firmTerminalId, $extraRefNo, $terminalDayCount,ThreeDSecure $ThreeDSecureData, DealerData $dealerData){
    // $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
    // $this->requestData['DealerData'] = $dealerData;
    // $this->requestData['MAC']= $this->getMac3D($ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    ...
    // }
    // function doTrioSingleWithDueDate($Amount, $CurrencyCode, $OrderId, $firmTerminalId, $extraRefNo, $dueDate,ThreeDSecure $ThreeDSecureData, DealerData $dealerData){
    // $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
    // $this->requestData['DealerData'] = $dealerData;
    // $this->requestData['MAC']= $this->getMac3D($ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    ...
    // function doTrioMultipleWithTerminalDayCount ($Amount, $CurrencyCode,$OrderId , $InstallmentCount, $firmTerminalId, $extraRefNo, $terminalDayCount,ThreeDSecure $ThreeDSecureData, DealerData $dealerData){
    // $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
    // $this->requestData['DealerData'] = $dealerData;
    // $this->requestData['MAC']= $this->getMac3D($ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    ...
    // function doTrioMultipleWithDueDate ($Amount, $CurrencyCode,$OrderId , $InstallmentCount, $firmTerminalId, $extraRefNo, $dueDate,ThreeDSecure $ThreeDSecureData, DealerData $dealerData){
    // $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
    // $this->requestData['DealerData'] = $dealerData;
    // $this->requestData['MAC']= $this->getMac3D($ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    ...
    // //TODO: response
    // function doTrioFlexibleWithTerminalDayCount ($CurrencyCode, $OrderId, $InstallmentCount, $firmTerminalId, $extraRefNo, $terminalDayCount,$dueInfoList,ThreeDSecure $ThreeDSecureData, DealerData $dealerData){
    // $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
    // $this->requestData['DealerData'] = $dealerData;
    // $this->requestData['MAC']= $this->getMac3D($ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    ...
    // $this->requestData['MAC']= $this->getMac3D($trioFlexibleRequestData->ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    ...
    // function doTrioFixed($noWarranty, $amount, $currencyCode,$OrderId, $firmTerminalId, $extraRefNo,ThreeDSecure $ThreeDSecureData, DealerData $dealerData){
    // $this->requestData['ThreeDSecureData'] = $ThreeDSecureData;
    // $this->requestData['DealerData'] = $dealerData;
    // $this->requestData['MAC']= $this->getMac3D($ThreeDSecureData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
    ...
    // $this->requestData['MAC']= $this->getMac3D($trioFixedRequestData->CardInformationData);
    // $this->requestData['MACParams']="MerchantNo:TerminalNo:SecureTransactionId:CavvData:Eci:MdStatus";
