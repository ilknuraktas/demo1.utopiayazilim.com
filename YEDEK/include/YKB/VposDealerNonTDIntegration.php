...
include_once 'Models/DealerData.php';
...
class VposDealerNonTDIntegration extends BaseClass
{
    ...
    // Sale
    function doSale(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderId, $koiCode , $merchantMessageData ,DealerData $dealerData)
    {
	if( $koiCode != "")
	{
	...
	if( $merchantMessageData  != "")
	{
	   $this->requestData['merchantMessageData'] = $merchantMessageData;
        ...
        $this->requestData['DealerData'] = $dealerData;
    ...
    function doSaleWithPoint(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderId, $Point, $koiCode , $merchantMessageData , DealerData $dealerData)
    {
    ...
    function doSaleWithInstallment(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderId, $InstallmentCount, $koiCode , $merchantMessageData ,DealerData $dealerData)
    {
    ...
    function doSaleWithPointAndInstalment(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderId, $Point, $InstallmentCount, $koiCode , $merchantMessageData ,DealerData $dealerData)
    {
    ...
    // Auth
    function doAuth(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderId, $koiCode , $merchantMessageData ,DealerData $dealerData)
    {
    ...
    function doAuthWithInstallment(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderId, $InstallmentCount, $koiCode , $merchantMessageData , DealerData $dealerData)
    {
    ...
    // Capture
    function doCapture($Amount, $CurrencyCode, $ReferenceCode, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
    ...
    function doCaptureWithInstallment($Amount, $CurrencyCode, $ReferenceCode, $InstallmentCount, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMac();
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo";
    ...
    // Vft
    function doVft(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderID, $InstallmentCount, $VftCode, $koiCode , $merchantMessageData ,DealerData $dealerData)
    {
    ...
    // DoPointUsage
    function doPointUsage(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderId, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    // DoReturn
    function doReturnWithOrederId($Amount, $CurrencyCode, $OrderId, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
    ...
    function doReturnWithReferenceCode($Amount, $CurrencyCode, $ReferenceCode, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMACReference($ReferenceCode, $OrderId);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:ReferenceCode:OrderId";
	...
	function doUnmatchedReturn(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderId, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
		$this->requestData['CardInformationData'] = $cardInformationData;
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo";
    ...
    function doPointUsageReturnWithOrederId($Amount, $CurrencyCode, $OrderId, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMACReference($ReferenceCode, $OrderId);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:ReferenceCode:OrderId";
    ...
    function doPointUsageReturnWithReferenceCode($Amount, $CurrencyCode, $ReferenceCode, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMACReference($ReferenceCode, $OrderId);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:ReferenceCode:OrderId";
    ...
    // DoReverse
    function doReverseWithReferenceCode( $ReferenceCode, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMACReference($ReferenceCode, $OrderId);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:ReferenceCode:OrderId";
    ...
    function doReverseWithOrderId( $OrderId, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMACReference($ReferenceCode, $OrderId);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:ReferenceCode:OrderId";
     ...
     */
    function doReverse( $ReferenceCode, $OrderId, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMACReference($ReferenceCode, $OrderId);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:ReferenceCode:OrderId";
    ...
    // DoVftQuery
    function doVftQuery(CardInformationData $cardInformationData, $Amount, $InstallmentCount, $VftCode, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    // DoKOICampaignQuery
    function doKOICampaignQuery(CardInformationData $cardInformationData, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    // PointInquiry
    function doPointInquiry(CardInformationData $cardInformationData, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    // Turkcell
    function doTurkcellSale(CardInformationData $cardInformationData, $OrderId, $packetCode, $gsmNo, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    // DoAgreement
    function doAgreement($OrderId, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMac();
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo";
    ...
    // TRIO
    //
    function doTrioSingleWithTerminalDayCount(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderId, $firmTerminalId, $extraRefNo, $terminalDayCount, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    function doTrioSingleWithDueDate(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderId, $firmTerminalId, $extraRefNo, $dueDate, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    function doTrioMultipleWithTerminalDayCount(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderId, $InstallmentCount, $firmTerminalId, $extraRefNo, $terminalDayCount, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    function doTrioMultipleWithDueDate(CardInformationData $cardInformationData, $Amount, $CurrencyCode, $OrderId, $InstallmentCount, $firmTerminalId, $extraRefNo, $dueDate, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    // TODO: response
    function doTrioFlexibleWithTerminalDayCount(CardInformationData $cardInformationData, $CurrencyCode, $OrderId, $InstallmentCount, $firmTerminalId, $extraRefNo, $terminalDayCount, $dueInfoList, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    function doTrioFixed(CardInformationData $cardInformationData, $noWarranty, $amount, $currencyCode, $OrderId, $firmTerminalId, $extraRefNo, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    function doTrioReturnWithReferenceCode($AuthCode, $ReferenceCode, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMACReference($ReferenceCode, $OrderId);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:ReferenceCode:OrderId";
    ...
    function doTrioReturnWithOrderId($AuthCode, $OrderId, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMACReference($ReferenceCode, $OrderId);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:ReferenceCode:OrderId";
    ...
    function doTrioAvailableLimitInquiry(CardInformationData $cardInformationData, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    function doTrioPaymentListInquiry(CardInformationData $cardInformationData, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMAcWithCardInfo($cardInformationData);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:CardNo:Cvc2:ExpireDate";
    ...
    function doTrioPaymentDelayWithOrederId($OrderId, $AuthCode, $InstallmentCount, $DueDate, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMACReference($ReferenceCode, $OrderId);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:ReferenceCode:OrderId";
    ...
    function doTrioPaymentDelayWithReferenceCode($ReferenceCode, $AuthCode, $InstallmentCount, $DueDate, DealerData $dealerData)
    {
        $this->requestData['DealerData'] = $dealerData;
        $this->requestData['MAC'] = $this->getMACReference($ReferenceCode, $OrderId);
        $this->requestData['MACParams'] = "MerchantNo:TerminalNo:ReferenceCode:OrderId";
