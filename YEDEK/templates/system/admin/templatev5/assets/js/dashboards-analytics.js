...
(function () {
  ...
  const analyticsBarChartEl = document.querySelector('#analyticsBarChart'),
    analyticsBarChartConfig = {
      ...
      series: (typeof analyticsBarChartSeries != 'undefined'?analyticsBarChartSeries:[]),
      grid: {
      ...
      xaxis: {
        categories: (typeof analyticsBarChartCategories != 'undefined'?analyticsBarChartCategories:[]),
        axisBorder: {
          show: false
        },
        axisTicks: {
  ...
  const analyticsBarChartEl2 = document.querySelector('#analyticsBarChart2'),
    analyticsBarChartConfig2 = {
      ...
      colors: [config.colors.success, config.colors_label.primary],
      series: (typeof analyticsBarChartSeries2 != 'undefined'?analyticsBarChartSeries2:[]),
      grid: {
        borderColor: borderColor,
        padding: {
          bottom: -8
      ...
      xaxis: {
        categories: (typeof analyticsBarChartCategories2 != 'undefined'?analyticsBarChartCategories2:[]),
        axisBorder: {
          show: false
        },
        axisTicks: {
  ...
  if (typeof analyticsBarChartEl2 !== undefined && analyticsBarChartEl2 !== null) {
    analyticsBarChart2 = new ApexCharts(analyticsBarChartEl2, analyticsBarChartConfig2);
  ...
  // 3
   ...
   // Analytics - Bar Chart
  // --------------------------------------------------------------------
  const analyticsBarChartEl3 = document.querySelector('#analyticsBarChart3'),
    analyticsBarChartConfig3 = {
      chart: {
        height: 128,
        type: 'bar',
        toolbar: {
      ...
      colors: [config.colors.secondary, config.colors_label.primary],
      series: (typeof analyticsBarChartSeries3 != 'undefined'?analyticsBarChartSeries3:[]),
      grid: {
        borderColor: borderColor,
        padding: {
          bottom: -8
      ...
      xaxis: {
        categories: (typeof analyticsBarChartCategories3 != 'undefined'?analyticsBarChartCategories3:[]),
        axisBorder: {
          show: false
        },
        axisTicks: {
  ...
  if (typeof analyticsBarChartEl3 !== undefined && analyticsBarChartEl3 !== null) {
    analyticsBarChart3 = new ApexCharts(analyticsBarChartEl3, analyticsBarChartConfig3);
