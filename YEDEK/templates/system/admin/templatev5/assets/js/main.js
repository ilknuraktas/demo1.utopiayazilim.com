...
if (typeof $ !== 'undefined') {
  $(function () {
    ...
    if (searchInput) {
      ...
      var searchData = $.ajax({
        url: 'ajax.php?act=arama', //? Use your own search api instead
        dataType: 'json',
        async: false
      }).responseJSON;
        ...
        searchInput
          .typeahead(
            ...
            // Pages
            {
              ...
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Paneller</h6>',
                ...
                notFound:
                  ...
                  '<h6 class="suggestions-header text-primary mb-2">Paneller</h6>' +
                  '<p class="py-2 mb-0"><i class="bx bx-error-circle bx-xs me-2"></i> Başlık bulunamadı.</p>' +
                  '</div>'
              }
            }
          )
