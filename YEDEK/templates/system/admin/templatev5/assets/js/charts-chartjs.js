...
(function () {
  ...
  if (horizontalBarChart) {
    const horizontalBarChartVar = new Chart(horizontalBarChart, {
      type: 'bar',
      data: {
        labels: (typeof kategoriLabel1 != 'undefined'?kategoriLabel1:[]),
        datasets: [
          {
            data: (typeof kategoriData1 != 'undefined'?kategoriData1:[]),
  ...
  const horizontalBarChart2 = document.getElementById('horizontalBarChart2');
  if (horizontalBarChart2) {
    const horizontalBarChartVar2 = new Chart(horizontalBarChart2, {
      type: 'bar',
      data: {
        labels: (typeof kategoriLabel2 != 'undefined'?kategoriLabel2:[]),
        datasets: [
          {
            data: (typeof kategoriData2 != 'undefined'?kategoriData2:[]),
  ...
  const horizontalBarChart3 = document.getElementById('horizontalBarChart3');
  if (horizontalBarChart3) {
    const horizontalBarChartVar3 = new Chart(horizontalBarChart3, {
      type: 'bar',
      data: {
        labels: (typeof kategoriLabel3 != 'undefined'?kategoriLabel3:[]),
        datasets: [
          {
            data: (typeof kategoriData3 != 'undefined'?kategoriData3:[]),
  ...
  if (polarChart) {
    const polarChartVar = new Chart(polarChart, {
      type: 'polarArea',
      data: {
        labels: (typeof polarLabel != 'undefined'?polarLabel:[]),
        datasets: [
          {
            label: 'İstatistik',
            backgroundColor: [purpleColor, yellowColor, orangeColor,orangeLightColor,  oceanBlueColor,greyLightColor, greyColor,greyLightColor, cyanColor,blueColor,blueLightColor],
            data: (typeof polarData != 'undefined'?polarData:[]),
            borderWidth: 0
          }
        ]
      },
  ...
  const polarChart2 = document.getElementById('polarChart2');
  if (polarChart2) {
    const polarChartVar2 = new Chart(polarChart2, {
      type: 'polarArea',
      data: {
        labels: (typeof polarLabel2 != 'undefined'?polarLabel2:[]),
        datasets: [
          {
            label: 'İstatistik',
            backgroundColor: [purpleColor, yellowColor, orangeColor,orangeLightColor,  oceanBlueColor,greyLightColor, greyColor,greyLightColor, cyanColor,blueColor,blueLightColor],
            data: (typeof polarData2 != 'undefined'?polarData2:[]),
            borderWidth: 0
          }
        ]
      },
