(function ($) {
	...
	$.Autocompleter = function (o, r) {
		...
		function selectCurrent() {
			...
			if(u.hasClass('shopphp-search'))
			{
				u.val('Lütfen Bekleyin ...');
				window.location.href = 's.php?f=' + v;
			}
			else
				u.val(v.replace('&prime;',"'"));
			hideResultsNow();
...
$('document').ready(function() {
	...
	$('.shopphp-search').autocomplete('ajax.php?act=arama',{
			minChars: 2,
			width: 300,
			multiple: false,
			matchContains: true,
	...
	$('#answer').autocomplete('ajax.php?act=auto-complete',{
		minChars: 2,
		width: 557,
		multiple: false,
		matchContains: true,
