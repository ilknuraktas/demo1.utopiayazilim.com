            ...
            <div class="form-container active">
                <div class="row collapse">
                    <div class="small-6 columns" style="width:100%; float:none;">
                        <input name="cardno" autocomplete="off" class="jp-card-invalid mastercard identified" type="text" placeholder="Sodexo Gsm numaranız" vk_1763a="subscribed" id="cardno">
                    </div>
                    <div class="small-6 columns" style="width:100%; float:none;">
                        <input name="sifre" type="text" placeholder="Sodexo Mobil Ödeme Kodunuz" vk_1763a="subscribed">
                    </div>
                </div>
