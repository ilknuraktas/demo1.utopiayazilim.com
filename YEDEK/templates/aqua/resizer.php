...
ini_set('gd.jpeg_ignore_warning', true); // resim hatalarını engeller
...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', '../../cache/0');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
if(! defined('NOT_FOUND_IMAGE') )			define ('NOT_FOUND_IMAGE', 'images/404.png');							// Image to serve if any 404 occurs 
if(! defined('ERROR_IMAGE') )				define ('ERROR_IMAGE', 'images/403.png');								// Image to serve if an error occurs instead of showing error message 
