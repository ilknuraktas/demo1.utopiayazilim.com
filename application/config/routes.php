...
foreach ($languages as $language) {
    if ($language->status == 1) {
        ...
        $route[$routes->admin . '/evrak'] = 'admin_controller/evrak_list';
        /*product*/
        ...
        $route[$key . $routes->sell_now . '/' . 'toplu-al-duzenle' . '/(:num)']['GET'] = 'product_controller/toplu_duzenle/$1';
        ...
        $route[$key . $routes->excel_aktar]['GET'] = 'profile_controller/excel_aktar';
        /*promoted product*/
        ...
        $route[$key . 'ucretsiz-kargo']['GET'] = 'earnings_controller/ucretsiz_kargo';
        $route[$key . 'toplu-al-az-ode']['GET'] = 'earnings_controller/toplu_al';
        $route[$key . $routes->toplu_veri]['GET'] = 'earnings_controller/toplu_veri';

        $route[$key . $routes->entegrasyon]['GET'] = 'earnings_controller/entegrasyon_ayarlari';

        $route[$key . $routes->entegrasyon . '/(:any)']['GET'] = 'earnings_controller/entegrasyon_kargo_ayarlari/$1';


        $route[$key . $routes->urunlerim]['GET'] = 'earnings_controller/my_products';
        $route[$key . $routes->urunlerim . '/(:any)']['GET'] = 'earnings_controller/my_products_view/$1';

        $route[$key . $routes->urun_listesi]['GET'] = 'earnings_controller/urun_listesi';
        $route[$key . $routes->satis_kazanclari]['GET'] = 'earnings_controller/satis_kazanclari';
...
$route[$routes->admin . '/import_excel'] = 'product_admin_controller/import_excel';
...
/*seo tools routes*/
$route[$routes->admin . '/stories'] = 'admin_controller/stories';
$route[$routes->admin . '/sms-ayarlari'] = 'admin_controller/sms_settings';
$route[$routes->admin . '/sms-mesaj'] = 'admin_controller/sms_mesaj';
...
$route[$routes->admin . '/bayi'] = 'admin_controller/bayi';
