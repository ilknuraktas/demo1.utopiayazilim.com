...
class Home_controller extends Home_Core_Controller
{
    ...
    public function index()
    {
        ...
        $data["best_sellers_products"] = get_best_sellers_product();
        $data["trend_products"] = get_trend_products();

        $data["promoted_products_count"] = get_promoted_products_count();
        $data["best_sellers_products_count"] = get_promoted_products_count();
        $data["trend_products_count"] = get_promoted_products_count();
        ...
        $data["home_show_list"] = $this->category_model->get_all_parent_home_categories();
    ...
    */
    ...
    {
        $upload_files = $_FILES['upload_file']['name'];
        $extension = pathinfo($upload_files, PATHINFO_EXTENSION);

        $reader = new  PhpOffice\PhpSpreadsheet\Writer\Xlsx();
