...
class Message_controller extends Home_Core_Controller
{
    ...
    public function send_message()
    {
        ...
        $sms_a = $sms_ayar->row();
        $idler=$this->input->post('receiver_id', true);
        $query = $this->db->query("SELECT * FROM users WHERE id=".$idler);
        $row = $query->row();
        $this->auth_model->sms_send($row->phone_number,$sms_a->mesaj_musteri);
    ...
    public function add_conversation()
    {
        ...
        $query = $this->db->query("SELECT * FROM users WHERE id=".$idler);
        $row = $query->row();
        $this->auth_model->sms_send($row->phone_number,"$sms_a->mesaj_satici");
