...
class Profile_controller extends Home_Core_Controller
{
    ...
    public function excel_aktar()
    {
        ...
        $data['title'] = "Excel'den Aktar";
        $data['description'] = "Excel'den Aktar" . " - " . $this->app_name;
        $data['keywords'] = "Excel'den Aktar" . "," . $this->app_name;
        $data["active_tab"] = "Excel'den Aktar";
        $data["user_rating"] = calculate_user_rating($data["user"]->id);
        ...
        $this->load->view('profile/excel_products', $data);
