...
class Settings_model extends CI_Model
{
    ...
    public function update_settings()
    {
        $data = array(
            ...
            'contact_whatsapp1' => $this->input->post('contact_whatsapp1', true),
            'contact_whatsapp2' => $this->input->post('contact_whatsapp2', true),
            'contact_name_whatsapp1' => $this->input->post('contact_name_whatsapp1', true),
            'contact_name_whatsapp2' => $this->input->post('contact_name_whatsapp2', true),
			'copyright' => $this->input->post('copyright', true),
            'cookies_warning' => $this->input->post('cookies_warning', false),
            'whatsapp_area' => $this->input->post('whatsapp_number', false),
    ...
    public function update_pricing_settings()
    {
        $data = array(
            ...
            'price_per_year' => $this->input->post('price_per_year', true),
        ...
        $data['price_per_year'] = get_price($data["price_per_year"], 'database');
