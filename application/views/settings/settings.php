                            ...
                            <div class="tab-pane" id="tab_2">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3">
                                            <label class="control-label"><?php echo trans('whatsapp_number'); ?></label>
                                            <input type="text" class="form-control" name="contact_whatsapp"
                                            placeholder="<?php echo trans('whatsapp_number'); ?>" value="<?php echo html_escape($settings->contact_whatsapp); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                                        </div>
