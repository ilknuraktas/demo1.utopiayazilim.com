			...
			<div class="col-lg-12 col-md-12">
				<div class="card">
					<div class="card-header with-border">
						<h3 class="card-title"><?php echo trans('sitemap'); ?></h3>
					</div>
					<!-- /.box-header -->
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<p>
								<input type="radio" name="last_modification" id="last_modification_1" value="none" class="form-check-input" <?php echo ($this->form_settings->sitemap_last_modification == 'none') ? 'checked' : ''; ?>>
								<label for="last_modification_1" class="cursor-pointer">&nbsp;<?php echo trans('none'); ?></label>
							</p>
							<p>
								<input type="radio" name="last_modification" id="last_modification_2" value="server_response" class="form-check-input" <?php echo ($this->form_settings->sitemap_last_modification == 'server_response') ? 'checked' : ''; ?>>
						...
						<div class="form-group">
							...
							<p>
								<input type="radio" name="priority" id="priority_1" value="none" class="form-check-input" <?php echo ($this->form_settings->sitemap_priority == 'none') ? 'checked' : ''; ?>>
								<label for="priority_1" class="cursor-pointer">&nbsp;<?php echo trans('none'); ?></label>
							</p>
							<p>
								<input type="radio" name="priority" id="priority_2" value="automatically" class="form-check-input" <?php echo ($this->form_settings->sitemap_priority == 'automatically') ? 'checked' : ''; ?>>
								<label for="priority_2" class="cursor-pointer">&nbsp;<?php echo trans('priority_none'); ?></label>
							</p>
						</div>
					</div>
					<div class="card-footer">
						<button type="submit" name="process" value="generate" class="btn btn-secondary waves-effect btn-label waves-light">
							<i class="bx bx-cloud-download label-icon"></i>
							<?php echo trans('download_sitemap'); ?>
						</button>
						<button type="submit" name="process" value="update" class="btn btn-warning waves-effect btn-label waves-light">
							<i class="bx bx-check label-icon"></i>
							<?php echo trans('update_sitemap'); ?>
						</button>
					</div>
				...
				<div class="col-lg-12 col-md-12">
					<div class="card">
						...
						<div class="card-header">
							<p><strong>https://domain.com/cron/update-sitemap</strong></p>
