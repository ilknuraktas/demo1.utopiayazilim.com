			...
			<div class="col-lg-12 col-md-12">
				<div class="card card-primary">
					...
					<div class="card-header with-border">
						<h3 class="card-title"><?php echo trans('update_slider_item'); ?></h3>
					</div><!-- /.box-header -->
						...
						<div class="row row-form">
							...
							<div class="col-sm-12 col-md-4 col-form">
								<div class="form-group">
									...
									<input type="number" class="form-control" name="item_order" placeholder="<?php echo trans('sort_by'); ?>" value="<?php echo $item->item_order; ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
								</div>
							</div>
							<div class="col-sm-12 col-md-4 col-form">
								<div class="form-group">
