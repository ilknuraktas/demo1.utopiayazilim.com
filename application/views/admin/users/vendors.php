    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header with-border">
                <div class="left">
                    <h3 class="card-title"><?php echo trans('vendors'); ?></h3>
                </div>
            </div><!-- /.box-header -->
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0)" onclick="open_close_user_shop(<?php echo $user->id; ?>,'<?php echo trans("confirm_close_user_shop"); ?>');">
                                                                <?php echo trans('close_user_shop'); ?>
                                                        </a>
                                                        </li>
                                                        <li>
