                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="badge bg-success"><?php echo $user->role; ?></label>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4 col-profile">
                                    <img src="<?php echo html_escape(get_user_avatar($user)); ?>" alt="avatar" class="rounded avatar-xl">
                                </div>
                                <div class="col-sm-8 col-profile">
                                    <p>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <textarea style="height: 10px" class="form-control text-area" name="about_me" placeholder="<?php echo trans('shop_description'); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>><?php echo html_escape($user->about_me); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6 col-sm-3">
                                    ...
                                    placeholder="<?php echo trans('facebook_url'); ?>"
                                    value="<?php echo html_escape($user->facebook_url); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                                </div>
                                <div class="col-6 col-sm-3">
                                ...
                                <div class="col-6 col-sm-3">
                                    ...
                                    <input type="text" class="form-control form-input" name="instagram_url"
                                    placeholder="<?php echo trans('instagram_url'); ?>"
                                ...
                                <div class="col-6 col-sm-3">
                                    ...
                                    <input type="text" class="form-control form-input" name="pinterest_url"
                                    placeholder="<?php echo trans('pinterest_url'); ?>"
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6 col-sm-3">
                                    ...
                                    <input type="text" class="form-control form-input" name="linkedin_url"
                                    placeholder="<?php echo trans('linkedin_url'); ?>"
                                ...
                                <div class="col-6 col-sm-3">
                                    ...
                                    placeholder="<?php echo trans('vk_url'); ?>"
                                    value="<?php echo html_escape($user->vk_url); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                                </div>
                                <div class="col-6 col-sm-3">
                                    <label class="control-label"><?php echo trans('youtube_url'); ?></label>
                                    <input type="text" class="form-control form-input" name="youtube_url"
                                    placeholder="<?php echo trans('youtube_url'); ?>"
                                    value="<?php echo html_escape($user->youtube_url); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                                </div>
                                <?php if ($user->role == "bayi"): ?>
                                    <div class="col-6 col-sm-3">
                                        <label class="control-label">Bayi İskonto Ayarı</label>
                                        <input type="text" class="form-control form-input" name="iskonto"
                                        placeholder="Bayi İskonto Oranı (%)"
                                        value="<?php echo html_escape($user->iskonto); ?>">
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
