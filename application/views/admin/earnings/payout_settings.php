    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="card card-primary">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input class="form-check-input" type="radio" name="payout_paypal_enabled" value="1" id="paypal_enabled_1"
                                    class="square-purple" <?php echo ($this->payment_settings->payout_paypal_enabled == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="paypal_enabled_1"><?php echo trans('enable'); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input class="form-check-input" type="radio" name="payout_paypal_enabled" value="0" id="paypal_enabled_2"
                                    class="square-purple" <?php echo ($this->payment_settings->payout_paypal_enabled != 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="paypal_enabled_2"><?php echo trans('disable'); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary waves-effect btn-label waves-light"><i class="bx bx-check label-icon"></i><?php echo trans('save_changes'); ?></button>
                    </div>
                    <!-- /.box-footer -->
                    <!-- /.box -->
            ...
            <div class="col-lg-6 col-md-12">
                <div class="card card-primary">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('iban'); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input class="form-check-input" type="radio" name="payout_iban_enabled" value="1" id="iban_enabled_1"
                                    class="square-purple" <?php echo ($this->payment_settings->payout_iban_enabled == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="iban_enabled_1"><?php echo trans('enable'); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input class="form-check-input" type="radio" name="payout_iban_enabled" value="0" id="iban_enabled_2"
                                    class="square-purple" <?php echo ($this->payment_settings->payout_iban_enabled != 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="iban_enabled_2"><?php echo trans('disable'); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="card card-primary">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('swift'); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input class="form-check-input" type="radio" name="payout_swift_enabled" value="1" id="swift_enabled_1"
                                    class="square-purple" <?php echo ($this->payment_settings->payout_swift_enabled == 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="swift_enabled_1"><?php echo trans('enable'); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input class="form-check-input" type="radio" name="payout_swift_enabled" value="0" id="swift_enabled_2"
                                    class="square-purple" <?php echo ($this->payment_settings->payout_swift_enabled != 1) ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="swift_enabled_2"><?php echo trans('disable'); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
