											...
											<td>
												<div class="btn-group">
													...
													<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
														<li>
															<a class="dropdown-item" href="javascript:void(0)" onclick="delete_item('earnings_admin_controller/delete_earning_post','<?php echo $item->id; ?>','<?php echo trans("confirm_delete"); ?>');">
