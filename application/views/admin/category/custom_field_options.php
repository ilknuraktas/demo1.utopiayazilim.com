...
<div id="layout-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-12">
				<h1 class="card-title"><?php echo trans('custom_field_options'); ?></h1>
			</div>
		</div>
			...
			<div class="callout">
				<div class="card">
					<div class="card-header">
						<h4 class="card-title"><?php echo trans("custom_field"); ?></h4>
					</div>
				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header with-border">
							<h3 class="card-title"><?php echo trans("options"); ?></h3>
						</div>
						<!-- /.box-header -->
						<div class="card-body">
					...
					<div class="card-body">
						...
						<div class="form-group text-right">
							<button type="submit" class="btn btn-primary waves-effect btn-label waves-light">
								...
								<?php echo trans('select_category'); ?>
							</button>
						</div>
														...
														<tr>
															<td>
																...
																foreach ($categories_tree as $item_tree):
																	...
																	$count++;
																endforeach; ?>
																<button type="button" class="btn btn-danger waves-effect btn-label waves-light" onclick="delete_custom_field_category('<?php echo trans("confirm_delete"); ?>',<?php echo $field->id; ?>,<?php echo $item_category->id; ?>);">
