            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans("update_category"); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($category->visibility == '1') ? 'checked' : ''; ?>>
                                    <label for="visibility_1" class="form-check-label"><?php echo trans('show'); ?></label>
                                </div>
                                <div class="col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="visibility" value="0" id="visibility_2"
                                    class="form-check-input" <?php echo ($category->visibility == '0') ? 'checked' : ''; ?>>
                                    <label for="visibility_2" class="form-check-label"><?php echo trans('hide'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="show_on_homepage" value="1" id="show_on_homepage_1" class="form-check-input" <?php echo ($category->show_on_homepage == '1') ? 'checked' : ''; ?>>
                                    <label for="show_on_homepage_1" class="form-check-label"><?php echo trans('yes'); ?></label>
                                </div>
                                <div class="col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="show_on_homepage" value="0" id="show_on_homepage_2" class="form-check-input" <?php echo ($category->show_on_homepage == '0') ? 'checked' : ''; ?>>
                                    <label for="show_on_homepage_2" class="form-check-label"><?php echo trans('no'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4 col-xs-12">
                                    <label>Anasayfada Listele</label>
                                </div>
                                <div class="col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="home_show" value="1" id="home_show_1" class="form-check-input" <?php echo ($category->home_show == '1') ? 'checked' : ''; ?>>
                                    <label for="home_show_1" class="form-check-label"><?php echo trans('yes'); ?></label>
                                </div>
                                <div class="col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="home_show" value="0" id="home_show_2" class="form-check-input" <?php echo ($category->home_show == '0') ? 'checked' : ''; ?>>
                                    <label for="home_show_2" class="form-check-label"><?php echo trans('no'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="show_image_on_navigation" value="1" id="show_image_on_navigation_1" class="form-check-input" <?php echo ($category->show_image_on_navigation == '1') ? 'checked' : ''; ?>>
                                    <label for="show_image_on_navigation_1" class="form-check-label"><?php echo trans('yes'); ?></label>
                                </div>
                                <div class="col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="show_image_on_navigation" value="0" id="show_image_on_navigation_2" class="form-check-input" <?php echo ($category->show_image_on_navigation == '0') ? 'checked' : ''; ?>>
                                    <label for="show_image_on_navigation_2" class="form-check-label"><?php echo trans('no'); ?></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="display-block">
                                <input class="form-group" type="file" id="Multifileupload" name="file" size="40" accept=".png, .jpg, .jpeg, .gif">
                                <?php if (!empty($category->image)): ?>
