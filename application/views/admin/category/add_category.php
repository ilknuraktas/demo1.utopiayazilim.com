				...
				<div class="card">
					<div class="card-header with-border">
						<div class="d-flex flex-wrap align-items-center mb-3">
							<div class="left">
								<h3 class="card-title"><?php echo trans('add_category'); ?></h3>
							</div>
							<div class="ms-auto">
								<a href="<?php echo admin_url(); ?>categories" class="btn btn-success waves-effect btn-label waves-light">
					...
					<div class="card-body">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-sm-4 col-xs-12 col-option">
									<input type="radio" name="visibility" value="1" id="visibility_1" class="form-check-input" checked>
									<label for="visibility_1" class="form-check-label"><?php echo trans('show'); ?></label>
								</div>
								<div class="col-sm-4 col-xs-12 col-option">
									<input type="radio" name="visibility" value="0" id="visibility_2" class="form-check-input">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-sm-4 col-xs-12 col-option">
									<input type="radio" name="home_show" value="1" id="show_on_homepage_1" class="form-check-input">
									<label for="show_on_homepage_1" class="form-check-label"><?php echo trans('yes'); ?></label>
								</div>
								<div class="col-sm-4 col-xs-12 col-option">
									<input type="radio" name="home_show" value="0" id="show_on_homepage_2" class="form-check-input" checked>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-sm-4 col-xs-12 col-option">
									<input type="radio" name="show_image_on_navigation" value="1" id="show_image_on_navigation_1" class="form-check-input" checked>
									<label for="show_image_on_navigation_1" class="form-check-label"><?php echo trans('yes'); ?></label>
								</div>
								<div class="col-sm-4 col-xs-12 col-option">
									<input type="radio" name="show_image_on_navigation" value="0" id="show_image_on_navigation_2" class="form-check-input">
