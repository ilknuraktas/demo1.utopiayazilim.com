        ...
        <div class="mb-3">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <input name="q" class="form-control" placeholder="<?php echo trans("quote"); ?>" type="search" value="<?php echo html_escape($this->input->get('q', true)); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                <div class="col-md-3">
