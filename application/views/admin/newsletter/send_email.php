            ...
            <div class="col-xs-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('send_email_subscribers'); ?></h3>
                    </div>
                    <!-- /.box-header -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-sm-12 mb-3">
                               <button type="button" class="btn btn-secondary waves-effect waves-light btn_ck_add_image"><i class="icon-image"></i><?php echo trans("add_image"); ?></button>
                           </div>
                       </div>
               ...
               <div class="card-footer">
                <button type="submit" class="btn btn-primary waves-effect btn-label waves-light">
                    <i class="bx bxs-paper-plane label-icon"></i>
                    <?php echo trans('send_email'); ?>
                </button>
                <button type="button" id="btn_email_preview" class="btn btn-warning waves-effect btn-label waves-light">
                    <i class="bx bx-customize label-icon"></i>
