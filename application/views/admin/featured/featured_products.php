                        ...
                        <table class="table table-bordered table-striped" role="grid">
                                ...
                                <?php foreach ($products as $item): ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">
                                            <img src="https://cdn.dsmcdn.com/mnresize/250/250/indexing-sticker-stamp/moon/e68c3d96-a877-4e49-923b-ca420419ab40.png" height="40">
                                        </td>
                                        <td class="td-product">
                                            <?php if ($item->is_promoted == 1): ?>
                                                <label class="badge bg-success"><?php echo trans("featured"); ?></label>
                                            <?php endif; ?>
                                            <div class="img-table">
                                                <a href="<?php echo generate_product_url($item); ?>" target="_blank">
                                                    <img src="<?php echo get_product_image($item->id, 'image_small'); ?>" data-src="" alt="" class="rounded-circle avatar-md"/>
                                                </a>
                                            </div>
                            ...
                            <td>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    <li>
                                        <a class="dropdown-item" href="<?php echo admin_url(); ?>product-details/<?php echo html_escape($item->id); ?>"><?php echo trans('view_details'); ?></a>
                                    </li>
                                    <?php if ($item->is_promoted == 1): ?>
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" onclick="remove_from_featured('<?php echo html_escape($item->id); ?>');"><?php echo trans('remove_from_featured'); ?></a>
                                        </li>
                                    <?php else: ?>
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" onclick="$('#day_count_product_id').val('<?php echo html_escape($item->id); ?>');" data-toggle="modal" data-target="#myModal"><?php echo trans('add_to_featured'); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <li>
                                        <a class="dropdown-item" href="<?php echo generate_url("sell_now","edit_product"); ?>/<?php echo html_escape($item->id); ?>" target="_blank"><?php echo trans('edit'); ?></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="delete_item('product_admin_controller/delete_product','<?php echo $item->id; ?>','<?php echo trans("confirm_product"); ?>');"><?php echo trans('delete'); ?></a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="delete_item('product_admin_controller/delete_product_permanently','<?php echo $item->id; ?>','<?php echo trans("confirm_product_permanent"); ?>');"><?php echo trans('delete_permanently'); ?></a>
                                    </li>
                                </ul>
                            </div>
                        </td>
