            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('product_comments'); ?></h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($comments as $item): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo form_open('product_admin_controller/approve_comment_post'); ?>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        ...
                                                        <?php endif; ?>
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0)" onclick="delete_item('product_admin_controller/delete_comment','<?php echo $item->id; ?>','<?php echo trans("confirm_comment"); ?>');">
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="pull-left">
                                    <button class="btn btn-danger waves-effect btn-label waves-light btn-table-delete" onclick="delete_selected_comments('<?php echo trans("confirm_comments"); ?>');">
                                        <i class="bx bx-trash label-icon"></i>
                                        <?php echo trans('delete'); ?>
                                    </button>
                                    <?php if ($show_approve_button == true): ?>
                                        <button class="btn btn-primary waves-effect btn-label waves-light btn-table-delete" onclick="approve_selected_comments();">
