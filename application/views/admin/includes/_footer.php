...
<script src="<?php echo base_url(); ?>assets/store/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="<?php echo base_url(); ?>assets/store/assets/libs/metismenujs/metismenujs.min.js"></script>
<script src="<?php echo base_url(); ?>assets/store/assets/libs/simplebar/simplebar.min.js"></script>
<script src="<?php echo base_url(); ?>assets/store/assets/libs/feather-icons/feather.min.js"></script>
<script src="<?php echo base_url(); ?>assets/store/assets/js/app.js"></script>
<script src="<?php echo base_url(); ?>assets/store/assets/js/pages/alert.init.js"></script>
<script src="<?php echo base_url(); ?>assets/store/assets/libs/gridjs/gridjs.umd.js"></script>
<script src="<?php echo base_url(); ?>assets/store/assets/js/pages/gridjs.init.js"></script>
<script src="<?php echo base_url(); ?>assets/store/assets/libs/masonry-layout/masonry.pkgd.min.js"></script>
<!-- Bootstrap Toggle Js -->
...
<script src="<?php echo base_url(); ?>assets/admin/js/dashboard.init.js"></script>
<script src="<?php echo base_url(); ?>assets/admin/js/app.init.js"></script>
<!-- iCheck js -->
