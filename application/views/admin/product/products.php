                        ...
                        <tbody>
                                    ...
                                    <td class="td-product">
                                        ...
                                        <div>
                                            <a href="<?php echo generate_product_url($item); ?>" target="_blank">
                                                <img src="<?php echo get_product_image($item->id, 'image_small'); ?>" data-src="" alt="" class="rounded-circle avatar-sm"/>
                                            </a>
                                        </div>
                            ...
                            <td>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    ...
                                    <?php else: ?>
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" onclick="$('#day_count_product_id').val('<?php echo html_escape($item->id); ?>');" data-bs-toggle="modal" data-bs-target="#myModal"><?php echo trans('add_to_featured'); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    <li>
                                        <a class="dropdown-item" href="<?php echo generate_url("sell_now", "edit_product") . "/" . $item->id; ?>"><?php echo trans('edit'); ?></a>
                                    </li>
                                    <li>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title"><?php echo trans('add_to_featured'); ?></h5>
