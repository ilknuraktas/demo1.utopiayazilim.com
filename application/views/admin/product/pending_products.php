                                            ...
                                            <td class="td-product">
                                                ...
                                                <div class="img-table" style="height: 100px;">
                                                    <a href="<?php echo generate_product_url($item); ?>" target="_blank">
                                                        <img src="<?php echo get_product_image($item->id, 'image_small'); ?>" data-src="" alt="" class="rounded-circle avatar-lg"/>
                                                    </a>
                                                </div>
                                    ...
                                    <td>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            <li class="dropdown-item">
                                                <a href="<?php echo admin_url(); ?>product-details/<?php echo html_escape($item->id); ?>"><?php echo trans('view_details'); ?></a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="javascript:void(0)" onclick="approve_product('<?php echo $item->id; ?>');"><?php echo trans('approve'); ?></a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="<?php echo generate_url("sell_now","edit_product"); ?>/<?php echo html_escape($item->id); ?>" target="_blank"><?php echo trans('edit'); ?></a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="javascript:void(0)" onclick="delete_item('product_admin_controller/delete_product','<?php echo $item->id; ?>','<?php echo trans("confirm_product"); ?>');"><?php echo trans('delete'); ?></a>
                                            </li>
                                            <li class="dropdown-item">
                                                <a href="javascript:void(0)" onclick="delete_item('product_admin_controller/delete_product_permanently','<?php echo $item->id; ?>','<?php echo trans("confirm_product_permanent"); ?>');"><?php echo trans('delete_permanently'); ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                </td>
                ...
                <div class="col-sm-12 table-ft">
                    <div class="row">
                        ...
                        <?php if (count($products) > 0): ?>
                            <div class="pull-left">
                                <button class="btn btn-danger waves-effect btn-label waves-light" onclick="delete_selected_products('<?php echo trans("confirm_products"); ?>');"><i class="bx bx-trash label-icon"></i><?php echo trans('delete'); ?></button>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
