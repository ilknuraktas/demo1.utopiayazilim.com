                                        ...
                                        <td>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                <li class="dropdown-item">
                                                    <a href="javascript:void(0)" onclick="restore_product('<?php echo $item->id; ?>');"><?php echo trans('restore'); ?></a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a href="<?php echo admin_url(); ?>product-details/<?php echo html_escape($item->id); ?>"><?php echo trans('view_details'); ?></a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a href="<?php echo base_url(); ?>sell-now/edit-product/<?php echo html_escape($item->id); ?>" target="_blank"><?php echo trans('edit'); ?></a>
                                                </li>
                                                <li class="dropdown-item">
                    ...
                    <div class="col-sm-12 table-ft">
                        <div class="row">
                            ...
                            <?php if (count($products) > 0): ?>
                                <div class="pull-left">
                                    <button class="btn btn-danger waves-effect btn-label waves-light" onclick="delete_selected_products_permanently('<?php echo trans("confirm_products"); ?>');">
