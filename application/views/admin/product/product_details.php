            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('product_details'); ?></h3>
                    </div><!-- /.box-header -->
                    ...
                    <div class="card-body">
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        <?php foreach ($images as $image): ?>
                                            <img class="rounded avatar-xl" src="<?php echo get_product_image_url($image, 'image_small'); ?>" alt="">
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row row-product-details">
                            ...
                            <div class="col-md-10 col-sm-8 right">
                        ...
                        <div class="row row-product-details">
                            <div class="col-md-2 col-sm-4">
                                <label class="control-label"><?php echo trans('promote'); ?></label>
                            </div>
                            <div class="col-md-10 col-sm-8 right">
                                <?php if ($product->is_promoted == 1): ?>
                                    <label style="margin-right: 20px" class="badge bg-success"><?php echo trans("yes"); ?></label>
                                    <?php if ($product->status == 1): ?>
                                        <label style="margin-right: 10px"><b><?php echo trans("start"); ?>:</b> &nbsp;<?php echo $product->promote_start_date; ?></label>
                                        <label style="margin-right: 10px"><b><?php echo trans("end"); ?>:</b> &nbsp;<?php echo $product->promote_end_date; ?></label>
                                        <label style="margin-right: 10px"><b><?php echo trans("remaining_days"); ?>:</b> &nbsp;<strong><?php echo date_difference($product->promote_end_date, date('Y-m-d H:i:s')); ?></strong></label>
                                    <?php else: ?>
                        ...
                        <div class="row row-product-details">
                            ...
                            <div class="col-md-4 col-sm-8 right">
                                <?php if ($product->status == 1): ?>
                                    <label class="badge bg-success"><?php echo trans("active"); ?></label>
                                <?php else: ?>
                                    <label class="badge bg-warning"><?php echo trans("pending"); ?></label>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-8 right">
                                <?php if ($product->visibility == 1): ?>
                                    <label class="badge bg-success"><?php echo trans("visible"); ?></label>
                                <?php else: ?>
                                    <label class="badge bg-secondary">:<?php echo trans("hidden"); ?></label>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="row row-product-details">
                            <div class="col-md-2 col-sm-4">
                                <label class="control-label"><?php echo trans('seller'); ?></label>
                            </div>
                            <div class="col-md-4 col-sm-8 right">
                                <?php $user = get_user($product->user_id);
                                if (!empty($user)): ?>
                                    <a href="<?php echo generate_profile_url($user->slug); ?>" target="_blank">
                                        <!--img src="<?php echo get_user_avatar($user); ?>" alt="" class="rounded avatar-sm" style="float: left;margin-right: 10px;"-->
                            ...
                            <div class="col-md-4 col-sm-8 right">
                                ...
                                <div class="row row-product-details">
                                    ...
                                    <div class="col-md-10 col-sm-8 right description">
                            ...
                            <div class="card-footer">
                                ...
                                <?php if ($product->status != 1): ?>
                                    <button type="submit" name="option" value="approve" class="btn btn-success waves-effect btn-label waves-light">
                                        <i class="bx bx-left-arrow-alt label-icon"></i>
                                        <?php echo trans('approve'); ?>
                                    </button>
                                <?php endif; ?>
                                <a href="<?php echo $this->agent->referrer(); ?>" class="btn btn-danger waves-effect btn-label waves-light">
                                    <i class="bx bx-left-arrow-alt label-icon"></i>
                                    <?php echo trans('back'); ?>
                                </a>
                                <a href="<?php echo generate_url("sell_now", "edit_product"); ?>/<?php echo $product->id; ?>" class="btn btn-warning waves-effect btn-label waves-light">
