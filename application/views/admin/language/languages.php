			...
			<div class="col-lg-5 col-md-12">
				<div class="card">
					<div class="card-header with-border">
						<h3 class="card-title"><?php echo trans("default_language"); ?></h3>
					</div>
					<!-- /.box-header -->
				...
				<div class="card">
					<div class="card-header with-border">
						<h3 class="card-title"><?php echo trans("add_language"); ?></h3>
					</div>
					<!-- /.box-header -->
							...
							<div class="row">
								...
								<div class="col-lg-6 col-md-12">
									...
									<div class="display-block">
										<input type="file" class="form-control" id="Multifileupload" name="file" accept=".png, .jpg, .jpeg, .gif" required>
									</div>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-sm-4 col-xs-12 col-option">
									...
									<label class="form-check-label" for="status1"><?php echo trans('active'); ?></label>
								</div>
								<div class="col-sm-4 col-xs-12 col-option">
									<input class="form-check-input" type="radio" name="status" value="0" id="status2">
									<label class="form-check-label" for="status2"><?php echo trans('inactive'); ?></label>
								</div>
							</div>
						</div>
					...
					<div class="card-footer">
						<button type="submit" class="btn btn-success waves-effect btn-label waves-light">
							...
							<?php echo trans('add_language'); ?></button>
						</div>
						<!-- /.box-footer -->
						<?php echo form_close(); ?><!-- form end -->
					</div>
				...
				<div class="col-lg-7 col-md-12">
					<div class="card">
						<div class="card-header with-border">
							<div class="pull-left">
								<h3 class="card-title"><?php echo trans('languages'); ?></h3>
							</div>
						</div><!-- /.box-header -->
						<div class="card-body">
							<div class="row">
											...
											<tbody>
												...
												<?php foreach ($languages as $item): ?>
													<tr>
														...
														<td>
															<a href="<?php echo admin_url(); ?>translations/<?php echo $item->id; ?>?show=50" class="btn btn-warning waves-effect btn-label waves-light">
																<i class="bx bx-transfer-alt label-icon"></i>
																<?php echo trans('edit_translations'); ?>
															</a>
														</td>
														<td>
															<?php if ($item->status == 1): ?>
																<label class="text-success lbl-lang-status"><?php echo trans('active'); ?></label>
															<?php else: ?>
																<label class="text-danger lbl-lang-status"><?php echo trans('inactive'); ?></label>
															<?php endif; ?>
														</td>
														<td>
															<div class="btn-group">
																...
																<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
																	<li>
																		<a class="dropdown-item" href="<?php echo admin_url(); ?>update-language/<?php echo html_escape($item->id); ?>">
																			<?php echo trans('edit'); ?>
																		</a>
																	</li>
																	<li>
																		<a class="dropdown-item" href="javascript:void(0)" onclick="delete_item('language_controller/delete_language_post','<?php echo $item->id; ?>','<?php echo trans("confirm_language"); ?>');">
