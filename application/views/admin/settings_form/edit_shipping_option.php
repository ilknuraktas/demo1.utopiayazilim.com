            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans("edit_shipping_option"); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="shipping_cost" value="1" id="shipping_cost_1" class="form-check-input" <?php echo ($main_option->shipping_cost == 1) ? 'checked' : ''; ?>>
                                    <label for="shipping_cost_1" class="form-check-label"><?php echo trans('yes'); ?></label>
                                </div>
                                <div class="col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="shipping_cost" value="0" id="shipping_cost_2" class="form-check-input" <?php echo ($main_option->shipping_cost != 1) ? 'checked' : ''; ?>>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="is_visible" value="1" id="visible_1" class="form-check-input" <?php echo ($main_option->is_visible == 1) ? 'checked' : ''; ?>>
                                    <label for="visible_1" class="form-check-label"><?php echo trans('yes'); ?></label>
                                </div>
                                <div class="col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="is_visible" value="0" id="visible_2" class="form-check-input" <?php echo ($main_option->is_visible != 1) ? 'checked' : ''; ?>>
                    ...
                    <div class="card-footer">
                        <a href="<?php echo admin_url(); ?>form-settings/shipping-options" class="btn btn-danger waves-effect btn-label waves-light">
