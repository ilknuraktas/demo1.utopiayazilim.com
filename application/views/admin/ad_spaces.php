            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('ad_spaces'); ?></h3>
                    </div>
                    <!-- /.box-header -->
                        ...
                        <?php else: ?>
                            <div class="form-group">
                                ...
                                <p>
                                    ...
                                    <small><?php echo trans('ads_message_1'); ?></small>
                                </p>
                                <div class="row row-ad-space">
                                    <div class="col-sm-6">
                                        <label class="control-label"><?php echo trans('paste_ad_code'); ?></label>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <input type="file" class="form-control" name="file_ad_code_728" size="40" accept=".png, .jpg, .jpeg, .gif" onchange="$('#upload-file-info1').html($(this).val());">
                                            </div>
                                        </div>
                                ...
                                <p>
                                    ...
                                    <small><?php echo trans('ads_message_2'); ?></small>
                                </p>
                                <div class="row row-ad-space">
                                    <div class="col-sm-6">
                                        <label class="control-label"><?php echo trans('paste_ad_code'); ?></label>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <input type="file" class="form-control" name="file_ad_code_468" size="40" accept=".png, .jpg, .jpeg, .gif" onchange="$('#upload-file-info2').html($(this).val());">
                                            </div>
                                        </div>
                                ...
                                <p><label class="label label-primary">250x250 <?php echo trans('banner'); ?></label>&nbsp;&nbsp;
                                    <small><?php echo trans('ads_message_3'); ?></small>
                                </p>
                                <div class="row row-ad-space">
                                    <div class="col-sm-6">
                                        <label class="control-label"><?php echo trans('paste_ad_code'); ?></label>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <input type="file" class="form-control" name="file_ad_code_250" size="40" accept=".png, .jpg, .jpeg, .gif" onchange="$('#upload-file-info3').html($(this).val());">
                                            </div>
                                        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card box-primary">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('google_adsense_code'); ?><br><small><?php echo html_escape(trans("adsense_head_exp")); ?></small></h3>
