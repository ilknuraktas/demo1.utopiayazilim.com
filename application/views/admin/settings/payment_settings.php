...
<div id="layout-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="card-title"><?php echo trans('payment_settings'); ?></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('paypal'); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($this->payment_settings->paypal_enabled == 1) ? 'checked' : ''; ?>>
                                    <label for="paypal_enabled_1" class="form-check-label"><?php echo trans('enable'); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="paypal_enabled" value="0" id="paypal_enabled_2"
                                    class="form-check-input" <?php echo ($this->payment_settings->paypal_enabled != 1) ? 'checked' : ''; ?>>
                                    <label for="paypal_enabled_2" class="form-check-label"><?php echo trans('disable'); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($this->payment_settings->paypal_mode == 'live') ? 'checked' : ''; ?>>
                                    <label for="paypal_mode_1" class="form-check-label"><?php echo trans("production"); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="paypal_mode" value="sandbox" id="paypal_mode_2"
                                    class="form-check-input" <?php echo ($this->payment_settings->paypal_mode == 'sandbox') ? 'checked' : ''; ?>>
                                    <label for="paypal_mode_2" class="form-check-label"><?php echo trans("sandbox"); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-check-label"><?php echo trans('client_id'); ?></label>
                        ...
                        <div class="form-group">
                            <label class="form-check-label"><?php echo trans('secret_key'); ?></label>
                ...
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('paystack'); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($this->payment_settings->paystack_enabled == 1) ? 'checked' : ''; ?>>
                                    <label for="paystack_enabled_1" class="form-check-label"><?php echo trans('enable'); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="paystack_enabled" value="0" id="paystack_enabled_2"
                                    class="form-check-input" <?php echo ($this->payment_settings->paystack_enabled != 1) ? 'checked' : ''; ?>>
                                    <label for="paystack_enabled_2" class="form-check-label"><?php echo trans('disable'); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="form-check-label"><?php echo trans('public_key'); ?></label>
                ...
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('pagseguro'); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($this->payment_settings->pagseguro_enabled == 1) ? 'checked' : ''; ?>>
                                    <label for="pagseguro_enabled_1" class="form-check-label"><?php echo trans('enable'); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="pagseguro_enabled" value="0" id="pagseguro_enabled_2"
                                    class="form-check-input" <?php echo ($this->payment_settings->pagseguro_enabled != 1) ? 'checked' : ''; ?>>
                                    <label for="pagseguro_enabled_2" class="form-check-label"><?php echo trans('disable'); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($this->payment_settings->pagseguro_mode == 'production') ? 'checked' : ''; ?>>
                                    <label for="pagseguro_mode_1" class="form-check-label"><?php echo trans("production"); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="pagseguro_mode" value="sandbox" id="pagseguro_mode_2"
                                    class="form-check-input" <?php echo ($this->payment_settings->pagseguro_mode == 'sandbox') ? 'checked' : ''; ?>>
                                    <label for="pagseguro_mode_2" class="form-check-label"><?php echo trans("sandbox"); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-check-label"><?php echo trans('email'); ?></label>
                        ...
                        <div class="form-group">
                            <label class="form-check-label"><?php echo trans('token'); ?></label>
                ...
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('bank_transfer'); ?></h3><br>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($this->payment_settings->bank_transfer_enabled == 1) ? 'checked' : ''; ?>>
                                    <label for="bank_transfer_enabled_1" class="form-check-label"><?php echo trans('enable'); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="bank_transfer_enabled" value="0" id="bank_transfer_enabled_2"
                                    class="form-check-input" <?php echo ($this->payment_settings->bank_transfer_enabled != 1) ? 'checked' : ''; ?>>
                                    <label for="bank_transfer_enabled_2" class="form-check-label"><?php echo trans('disable'); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('stripe'); ?></h3>
                    </div>
                    <!-- /.box-header -->
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($this->payment_settings->stripe_enabled == 1) ? 'checked' : ''; ?>>
                                    <label for="stripe_enabled_1" class="form-check-label"><?php echo trans('enable'); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="stripe_enabled" value="0" id="stripe_enabled_2"
                                    class="form-check-input" <?php echo ($this->payment_settings->stripe_enabled != 1) ? 'checked' : ''; ?>>
                                    <label for="stripe_enabled_2" class="form-check-label"><?php echo trans('disable'); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($this->payment_settings->razorpay_enabled == 1) ? 'checked' : ''; ?>>
                                    <label for="razorpay_enabled_1" class="form-check-label"><?php echo trans('enable'); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="razorpay_enabled" value="0" id="razorpay_enabled_2"
                                    class="form-check-input" <?php echo ($this->payment_settings->razorpay_enabled != 1) ? 'checked' : ''; ?>>
                                    <label for="razorpay_enabled_2" class="form-check-label"><?php echo trans('disable'); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('iyzico'); ?></h3>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($this->payment_settings->iyzico_enabled == 1) ? 'checked' : ''; ?>>
                                    <label for="iyzico_enabled_1" class="form-check-label"><?php echo trans('enable'); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="iyzico_enabled" value="0" id="iyzico_enabled_2"
                                    class="form-check-input" <?php echo ($this->payment_settings->iyzico_enabled != 1) ? 'checked' : ''; ?>>
                                    <label for="iyzico_enabled_2" class="form-check-label"><?php echo trans('disable'); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($this->payment_settings->iyzico_mode == 'live') ? 'checked' : ''; ?>>
                                    <label for="iyzico_mode_1" class="form-check-label"><?php echo trans("production"); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="iyzico_mode" value="sandbox" id="iyzico_mode_2"
                                    class="form-check-input" <?php echo ($this->payment_settings->iyzico_mode == 'sandbox') ? 'checked' : ''; ?>>
                                    <label for="iyzico_mode_2" class="form-check-label"><?php echo trans("sandbox"); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($this->payment_settings->iyzico_type == "checkout_form") ? 'checked' : ''; ?>>
                                    <label for="checkout_form_1" class="form-check-label"><?php echo trans('checkout_form'); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="iyzico_type" value="marketplace" id="marketplace_1"
                                    class="form-check-input" <?php echo ($this->payment_settings->iyzico_type == "marketplace") ? 'checked' : ''; ?>>
                                    <label for="marketplace_1" class="form-check-label"><?php echo trans('marketplace'); ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div id="form_submerchant" <?php echo ($this->payment_settings->iyzico_type == "marketplace") ? "style='display: block'" : "style='display: none'"; ?>>
                            ...
                            <button type="button" class="btn btn-success waves-effect btn-label waves-light" data-bs-toggle="collapse" data-bs-target="#iyzico_collapse" style="margin-top: 10px;">
                                <i class="bx bx-plus label-icon"></i>
                                <?php echo trans("create_key"); ?>
                            </button>
                            <div class="row">
                                <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-12 col-option">
                                                    ...
                                                    class="form-check-input" <?php echo (empty(old("submerchant_type")) || old("submerchant_type") == 'PERSONAL') ? 'checked' : ''; ?>>
                                                    <label for="submerchant_type_1" class="form-check-label">Kişi</label>
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-12 col-option">
                                                    <input type="radio" name="submerchant_type" value="PRIVATE_COMPANY" id="submerchant_type_2"
                                                    class="form-check-input" <?php echo (old("submerchant_type") == 'PRIVATE_COMPANY') ? 'checked' : ''; ?>>
                                                    <label for="submerchant_type_2" class="form-check-label">Özel Şirket</label>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12 col-option">
                                                    ...
                                                    class="form-check-input" <?php echo (old("submerchant_type") == 'LIMITED_OR_JOINT_STOCK_COMPANY') ? 'checked' : ''; ?>>
                                                    <label for="submerchant_type_3" class="form-check-label">Limited veya Anonim Şirketi</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control" name="first_name" placeholder="<?php echo trans("first_name"); ?>" value="<?php echo old("first_name"); ?>">
                                                </div>
                                                <div class="col-sm-6 col-xs-12">
                                                    <label><?php echo trans("last_name"); ?></label>
                                                    <input type="text" class="form-control" name="last_name" placeholder="<?php echo trans("last_name"); ?>" value="<?php echo old("last_name"); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control" name="email" placeholder="<?php echo trans("email"); ?>" value="<?php echo old("email"); ?>">
                                                </div>
                                                <div class="col-sm-6 col-xs-12">
                                                    <label><?php echo trans("phone_number"); ?></label>
                                                    <input type="text" class="form-control" name="phone_number" placeholder="<?php echo trans("phone_number"); ?>" value="<?php echo old("phone_number"); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control" name="identity_number" placeholder="<?php echo trans("identity_number"); ?>" value="<?php echo old("identity_number"); ?>">
                                                </div>
                                                <div class="col-sm-6 col-xs-12">
                                                    <label><?php echo trans("iban"); ?></label>
                                                    <input type="text" class="form-control" name="iban" placeholder="TR18 0006 2001 1900 0006 6723 15" value="<?php echo old("iban"); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control" name="submerchant_name" placeholder="<?php echo trans('submerchant') . " " . trans("name"); ?>" value="<?php echo old("submerchant_name"); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group"> 
                                            <div class="row">
                                                <div class="col-sm-4 col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control" name="tax_office" placeholder="<?php echo trans("tax_office"); ?>" value="<?php echo old("tax_office"); ?>">
                                                </div>
                                                <div class="col-sm-4 col-xs-12">
                                                    <label><?php echo trans("tax_number"); ?></label>
                                                    <input type="text" class="form-control" name="tax_number" placeholder="<?php echo trans("tax_number"); ?>" value="<?php echo old("tax_number"); ?>">
                                                </div>
                                                <div class="col-sm-4 col-xs-12">
                                                    <label><?php echo trans("company_title"); ?></label>
                                                    <input type="text" class="form-control" name="company_title" placeholder="<?php echo trans("company_title"); ?>" value="<?php echo old("company_title"); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                ...
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans('cash_on_delivery'); ?></h3><br>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    ...
                                    class="form-check-input" <?php echo ($this->payment_settings->cash_on_delivery_enabled == 1) ? 'checked' : ''; ?>>
                                    <label for="cash_on_delivery_enabled_1" class="form-check-label"><?php echo trans('enable'); ?></label>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12 col-option">
                                    <input type="radio" name="cash_on_delivery_enabled" value="0" id="cash_on_delivery_enabled_2"
                                    class="form-check-input" <?php echo ($this->payment_settings->cash_on_delivery_enabled != 1) ? 'checked' : ''; ?>>
                                    <label for="cash_on_delivery_enabled_2" class="form-check-label"><?php echo trans('disable'); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
