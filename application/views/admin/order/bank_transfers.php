										...
										<tr>
											...
											<td>
												...
												<?php elseif ($item->status == 'approved'): ?>
													<label class="badge bg-success"><?php echo trans("approved"); ?></label>
												<?php elseif ($item->status == 'declined'): ?>
													<label class="badge bg-danger"><?php echo trans("declined"); ?></label>
												<?php endif; ?>
											</td>
											...
											<td>
												...
												<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
													<?php if ($item->status == 'pending'):
														...
														<?php endif; ?>
														<li class="dropdown-item">
															<button type="submit" name="option" value="declined">
																<?php echo trans('decline'); ?>
															</button>
														</li>
													<?php endif; ?>
													<li class="dropdown-item">
														<a href="javascript:void(0)" onclick="delete_item('order_admin_controller/delete_bank_transfer_post','<?php echo $item->id; ?>','<?php echo trans("confirm_delete"); ?>');">
