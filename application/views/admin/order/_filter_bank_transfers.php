            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="pending" <?php echo ($this->input->get('status', true) == 'pending') ? 'selected' : ''; ?>><?php echo trans("pending"); ?></option>
                        <option value="approved" <?php echo ($this->input->get('status', true) == 'approved') ? 'selected' : ''; ?>><?php echo trans("approved"); ?></option>
                        <option value="declined" <?php echo ($this->input->get('status', true) == 'declined') ? 'selected' : ''; ?>><?php echo trans("declined"); ?></option>
                    </select>
                </div>
