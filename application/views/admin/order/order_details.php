            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header with-border">
                        <h3 class="card-title"><?php echo trans("order_details"); ?></h3>
                    </div><!-- /.box-header -->
                                ...
                                <div class="row row-details">
                                    ...
                                    <div class="col-sm-8">
                                        <?php if ($order->status == 1): ?>
                                            <label class="badge bg-success"><?php echo trans("completed"); ?></label>
                                        <?php else: ?>
                                            <label class="badge bg-default"><?php echo trans("order_processing"); ?></label>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-xs-12">
                                                <div class="table-orders-user">
                                                    <a href="<?php echo generate_profile_url($buyer->slug); ?>" target="_blank">
                                                        <img src="<?php echo get_user_avatar($buyer); ?>" alt="" class="rounded-circle avatar-md">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <td>
                                                    <div class="img-table">
                                                        <a href="<?php echo generate_product_url_by_slug($item->product_slug); ?>" target="_blank">
                                                            <img src="<?php echo get_product_image($item->product_id, 'image_small'); ?>" data-src="" alt="" class="rounded-circle avatar-xl"/>
                                                        </a>
                                                    </div>
                                                    <p>
                                                ...
                                                <td>
                                                    <?php if (($item->product_type == 'digital' && $item->order_status != 'completed') || $item->product_type == 'physical'): ?>
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                            <li>
                                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#updateStatusModal_<?php echo $item->id; ?>">
                                                                    <?php echo trans('update_order_status'); ?>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="delete_item('order_admin_controller/delete_order_product_post','<?php echo $item->id; ?>','<?php echo trans("confirm_delete"); ?>');">
        ...
        <div class="col-sm-12">
            <div class="card" style="padding: 20px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <strong class="font-right"><?php echo price_formatted($item->product_vat, $item->product_currency); ?>&nbsp;(<?php echo $item->product_vat_rate; ?>%)</strong>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel"><?php echo trans("update_order_status"); ?></h4>
