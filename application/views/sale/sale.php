											...
											foreach ($order_products as $item) :
												if ($item->seller_id == $this->auth_user->id) :
													...
													<tr>
														...
														<td>
															<button class="btn btn-light w-100">İptal Et</button>
														</td>
													</tr>
								...
								<div class="form-group">
									...
									<div class="selectdiv">
										<select name="order_status" class="form-control order-status-select" data-order-product-id="<?php echo $item->id; ?>">
											...
											<?php endif; ?>
											<option value="">Kapıda Kredi Kartı</option>
											<option value="">Kapıda Nakit</option>
											<option value="">Normal Kargo</option>
											<option value="">Kargo İptali</option>
										</select>
									</div>
								</div>
							</div>
