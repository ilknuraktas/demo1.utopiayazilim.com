                                        ...
                                        <div class="form-box-body alert alert-info alert-dismissible fade show mb-0">
                                            ...
                                            <!--<div class="form-group">
                                                <label class="control-label">Hemen Al Bağlantısı</label>
                                                  <input type="text" name="external_link" class="form-control form-input" placeholder="Hemen Al Bağlantısı">
                                            </div> -->
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-12 col-sm-3">
                                                        <label class="control-label">Marka</label>
                                                        <input type="text" name="brand" class="form-control form-input" placeholder="Ürüne Ait Marka Giriniz">
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-sm-3">
                                                        ...
                                                        <input type="text" name="barcode" class="form-control form-input" placeholder="Ürün Barkodu">
                                                    </div>
                                                    <div class="col-12 col-sm-3">
                                                        <label class="control-label">GTIN Kodu</label>
                                                        <input type="text" name="GTIN_code" class="form-control form-input" placeholder="GTIN Kodu">
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 mb-2">
                                                        <button type="button" class="btn btn-secondary color-white btn_ck_add_image"><i class="icon-image"></i><?php echo trans("add_image"); ?></button>
                                                        <button type="button" class="btn btn-info color-white btn_ck_add_video"><i class="icon-image"></i><?php echo trans("add_video"); ?></button>
                                                        <button type="button" class="btn btn-warning color-white btn_ck_add_iframe"><i class="icon-image"></i><?php echo trans("add_iframe"); ?></button>
                                                    </div>
                                                </div>
