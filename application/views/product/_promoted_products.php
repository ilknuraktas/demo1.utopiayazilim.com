...
<div id="promoted_posts">
    <!--div class="row mb-4" style="justify-content: space-between">
        <div class="left">
            <h3 style="margin-left:-12px;color:#333;margin-bottom:4px;font-size:24px;text-transform:inherit" class="title"><?php echo trans("featured_products"); ?></h3>
            <p style="margin-bottom:0;font-size:17px;color:#333;margin-left:19px"><?php echo trans("featured_products_exp"); ?></p>
        </div>
        <a style="margin-right:15px;margin-left:20px;display: flex;-webkit-box-pack: justify;justify-content: space-between;-webkit-box-align: center;align-items: center;font-weight: 500;font-size:14px;color:#333" href="<?php echo generate_url("products"); ?>" class="link-see-more">
