        ...
        <div class="row">
            <div id="content" class="col-12">
                ...
                <div class="form-add-product card" style="padding:2rem;">
                            ...
                            <div class="form-box-body alert alert-info alert-dismissible fade show mb-0">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <button type="button" class="btn btn-success btn-variation waves-effect btn-label waves-light" data-bs-toggle="modal" data-bs-target="#addVariationModal">
                                                <i class="bx bx-plus label-icon"></i>
                                                <?php echo trans("add_variation"); ?>
                                                
                                            </button>
                                            <button type="button" class="btn btn-primary waves-effect btn-label waves-light" data-bs-toggle="modal" data-bs-target="#variationModalSelect">
                    ...
                    <div class="form-group m-t-15">
                        <?php if ($product->is_draft == 1): ?>
                            <a href="<?php echo generate_url("sell_now") . "/" . $product->id; ?>" class="btn btn-dark waves-effect btn-label waves-light"><i class="bx bx-left-arrow-alt label-icon"></i> <?php echo trans("back"); ?></a>
                            <button type="submit" name="submit" value="save_as_draft" class="btn btn-success waves-effect btn-label waves-light"><i class="bx bx-check-double label-icon"></i> <?php echo trans("save_as_draft"); ?></button>
                            <button type="submit" name="submit" value="submit" class="btn btn-primary waves-effect btn-label waves-light"><i class="bx bx-check-double label-icon"></i> <?php echo trans("submit"); ?></button>

                        <?php else: ?>
                            <a href="<?php echo generate_url("sell_now", "edit_product") . "/" . $product->id; ?>" id="btn_tab_product_images" class="btn btn-dark waves-effect btn-label waves-light "><i class="bx bx-left-arrow-alt label-icon"></i> <?php echo trans("back"); ?></a>
                            <button type="submit" name="submit" value="save_changes" class="btn btn-primary waves-effect btn-label waves-light "><i class="bx bx-check-double label-icon"></i> <?php echo trans("save_changes"); ?></button>
                        <?php endif; ?>
                    </div>
