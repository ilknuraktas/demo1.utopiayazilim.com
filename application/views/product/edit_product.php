                        ...
                        <div class="row">
                            <div class="col-12 m-b-30">
                                <div class="form-box-head">
                                    <h4 class="title"><?php echo trans("images"); ?></h4>
                                </div>
                                <?php $this->load->view("product/_image_update_box"); ?>
                            </div>
                            <div class="col-12 m-b-30">
                                <p class="alert alert-warning alert-dismissible fade show mb-0">
                                    <i class="mdi mdi-alert-outline me-2"></i>
                                    <?php echo trans("product_image_exp"); ?>
                                </p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="form-box">
                                        ...
                                        <div class="form-box-body alert alert-info alert-dismissible fade show mb-0">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <!--<div class="form-group">
                                                <label class="control-label">Hemen Al Bağlantısı</label>
                                                  <input type="text" name="external_link" value="<?php echo html_escape($product->external_link); ?>" class="form-control form-input" placeholder="Hemen Al Bağlantısı">
                                            </div>-->	
											...
											<div class="form-group">
                                                ...
                                                <input type="text" name="sku" class="form-control form-input" value="<?php echo html_escape($product->sku); ?>" placeholder="<?php echo trans("sku"); ?>">
                                                    </div>
													
                                                    <div class="col-12 col-sm-4">
                                                        <label class="control-label"><?php echo trans("barcode"); ?></label>
                                                <input type="text" name="barcode" class="form-control form-input" value="<?php echo html_escape($product->barcode); ?>" placeholder="<?php echo trans("barcode");  ?>&nbsp;(<?php echo trans("optional"); ?>)">
                                                    </div>
													
                                                    <div class="col-12 col-sm-4">
                                                        <label class="control-label"><?php echo trans("GTIN_code"); ?></label>
                                                <input type="text" name="GTIN_code" class="form-control form-input" value="<?php echo html_escape($product->GTIN_code); ?>" placeholder="<?php echo trans("GTIN_code"); ?>&nbsp;(<?php echo trans("optional"); ?>)">
                                                    </div>
                                    ...
                                    <div class="form-box">
                                        ...
                                        <div class="form-box-body alert alert-info alert-dismissible fade show mb-0">
                                            <div class="form-group">
                                                <label class="control-label">Trend Ürünlerde Gözüksün Mü?</label>
                                                <div class="selectdiv">
                                                    <select name="is_trend" class="form-control" required>
                                                        <option value="1" <?php echo ($product->is_trend == 1) ? 'selected' : ''; ?>><?php echo trans('visible'); ?></option>
                                                        <option value="0" <?php echo ($product->is_trend == 0) ? 'selected' : ''; ?>><?php echo trans('hidden'); ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <?php else: ?>
                                    <input type="hidden" name="is_trend" value="<?php echo $product->is_trend; ?>">
                                <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo generate_url("sell_now", "product_details") . "/" . $product->id; ?>" class="btn btn-warning waves-effect btn-label waves-light"><i class="bx bx-block label-icon"></i> <?php echo trans("edit_details"); ?></a>
