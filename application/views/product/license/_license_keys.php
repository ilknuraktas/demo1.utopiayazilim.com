...
<div class="form-box">
	<div class="form-box-head">
		...
		<div><small><?php echo trans("license_keys_exp"); ?></small></div>
	</div>
	<div class="form-box-body">

		<div class="form-group">
			<button type="button" class="btn btn-sm btn-secondary color-white m-r-10" data-bs-toggle="modal" data-bs-target="#addLicenseKeysModal">
				<?php echo trans("add_license_keys"); ?>
			</button>
			<button type="button" class="btn btn-sm btn-secondary color-white" data-bs-toggle="modal" data-bs-target="#viewLicenseKeysModal">
