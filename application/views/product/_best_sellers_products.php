...
<div id="promoted_posts">
    <!--div class="row mb-4" style="justify-content: space-between">
        <div class="left">
            <h3 style="margin-left:-12px;color:#2a41e8;margin-bottom:4px;font-size:24px;text-transform:inherit" class="title">Çok Satanlar</h3>
            <p style="margin-bottom:0;font-size:17px;color:#2a41e8;margin-left:19px">En çok satılan ürünler</p>
        </div>
    ...
    <input type="hidden" id="promoted_products_offset" value="<?php echo count($best_sellers_products); ?>">
    ...
    <?php if ($best_sellers_products_count > count($best_sellers_products)): ?>
