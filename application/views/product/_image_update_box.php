                ...
                foreach ($modesy_images as $modesy_image):?>
                    <li class="media">
                        ...
                        <?php if ($modesy_image->is_main == 1): ?>
                            <a href="javascript:void(0)" class="badge badge-success btn-primary badge-is-image-main btn-set-image-main"><?php echo trans("main"); ?></a>
                        <?php else: ?>
                            <a href="javascript:void(0)" class="badge badge-secondary btn-success badge-is-image-main btn-set-image-main" data-image-id="<?php echo $modesy_image->id; ?>" data-product-id="<?php echo $modesy_image->product_id; ?>"><?php echo trans("main"); ?></a>
                        <?php endif; ?>
                    </li>
                <?php endforeach;
            endif; ?>
