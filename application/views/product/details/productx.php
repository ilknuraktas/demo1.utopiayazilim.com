                ...
                <div class="product-details-container <?php echo ((!empty($video) || !empty($audio)) && item_count($product_images) < 2) ? "product-details-container-digital" : ""; ?>">
                    <div class="row">
                        ...
                        <!--div class="col-12 col-sm-12 col-md-2">
                            <div style="background-color: #f6f9ff; border: 1px solid #1a71eb; border-radius: 5px;">
                                <div style="padding: 10px 5px; border-bottom: 1px solid #1a71eb;">
                                    <?php echo trans("by"); ?>:&nbsp;
                                    <a style="color: #1a71eb;font-weight: 600;font-size: 14px;" href="<?php echo generate_profile_url($product->user_slug); ?>">
                                        <?php echo character_limiter(get_shop_name_product($product), 30, '..'); ?>
                                    </a>
                                </div>
                                <div style="padding: 5px 5px;">
                                    <span style="font-weight: 600;font-size: 14px;"><?=get_store_rank($product->user_id)?></span>
                                </div>
                                <div style="padding: 5px 5px;">
                                    <?php if ($this->auth_check): ?>
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#messageModal"  style="font-weight: 600;font-size: 14px;">
                                            <i style="color: #3665f3;font-weight:bold" class="icon-comment"></i> 
                                            <?php echo trans("ask_question") ?>
                                        </a>
                                    <?php else: ?>
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal" style="font-weight: 600;font-size: 14px;">
                                            <i style="color: #3665f3;font-weight:bold" class="icon-comment"></i> 
                                            <?php echo trans("ask_question") ?>
                                        </a>
                                    <?php endif; ?>
