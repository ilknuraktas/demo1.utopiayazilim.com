            ...
            <div class="tk-add-to-cart">
                <div class="row">
                    ...
                    <div class="col-12" style="margin-top: 10px;">
                        <span class="brk-color-filter__title font__family-montserrat font__weight-bold font__size-14 line__height-14 text-uppercase text-center" style="font-weight: 900; font-size: 14px;">
