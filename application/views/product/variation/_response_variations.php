                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($variation->variation_type != 'text' && $variation->variation_type != 'number'): ?>
                                        <a href="javascript:void(0)" class="btn btn-success waves-effect btn-label waves-light" onclick="add_product_variation_option('<?php echo $variation->id; ?>');">
                                            <span id="btn-variation-text-add-<?php echo $variation->id; ?>">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-primary waves-effect btn-label waves-light" onclick="view_product_variation_options('<?php echo $variation->id; ?>');">
                                            <span id="btn-variation-text-options-<?php echo $variation->id; ?>">
                                                <i class="bx bx-check label-icon"></i>
                                                <?php echo trans('view_options'); ?>
                                            </span>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="btn btn-warning waves-effect btn-label waves-light" onclick="edit_product_variation('<?php echo $variation->id; ?>');">
                                        <span id="btn-variation-edit-<?php echo $variation->id; ?>">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-danger waves-effect btn-label waves-light" onclick='delete_product_variation("<?php echo $variation->id; ?>","<?php echo trans("confirm_variation"); ?>");'><i class="bx bx-trash label-icon"></i><?php echo trans('delete'); ?></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
